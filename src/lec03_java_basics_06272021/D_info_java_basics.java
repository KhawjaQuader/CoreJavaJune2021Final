package lec03_java_basics_06272021;

/*
 * 
1) What is Java Reserved words?
...
2) How to change font size for syntax?
...
3) how to see the font bigger? how to smaller
-- Command/control +
-- Command/control -

4) How to Enable Tasks in Eclipse IDE?
-- It is used to find out, what kind of work is left behind and need attention.
Window -- Show View -- Tasks
We have to Use 
//TODO ----------- write what need to do -------
...
7) How to turn a upper case string to lower case string?
...
-- right click on Class/package, select refactor, the rename, change it accordingly. Please don't change Project name.
...
20) How to drag and drop of a class from one package to another?
...
public class D_info_java_basics { //start of of the class body
