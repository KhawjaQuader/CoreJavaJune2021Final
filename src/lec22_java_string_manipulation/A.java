...
/*
 <!-- HTML Info: https://www.w3schools.com/html/
     ...
     12) HTML tags are not case sensitive: <P> means the same as <p>. The HTML standard does not require lower case tags, but we recommends lower case in HTML, and demands lower case for stricter document types like XHTML
     ...
     22) control + ~ (tilde) = to open the terminal, the blue bar below to pull it up.
23) Summary for <a>
     ...
     24) Install Prettier code formatter plug in on VSC. See below video for setting.
         Code formating with prettier in VSC: https://www.youtube.com/watch?v=h3PJjP0nE98&t=211s
