...
public interface Car extends Taxi, Truck {
	// all these methods which are declared also called abstract method/unimplemented method
	...
	// from Java 1.8, JAVA implemented static type and default type method in interface
	//non abstract method
