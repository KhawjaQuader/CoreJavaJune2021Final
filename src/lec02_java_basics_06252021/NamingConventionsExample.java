...
// IT WILL BE MOVED FROM HERE, PLEASE IGNORE IT
...
// names like "string1, myarray1, no_1" are not acceptable as variable names because they are are not specific and can cause confusion like the variable below:
