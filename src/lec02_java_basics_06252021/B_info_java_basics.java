...
-- Command/Control + a to select, then Command/Control + i, but it can’t remove the white spaces. To remove also white spaces Command/Control a to select all, then  Shift+ Command/Control + f.

6) How to format disorganized code?
...
7) How to delete a specific line? and restore?
