...
3) Describe primitive type data?
		...
		long = –9,223,372,036,854,775,808 to 9,223,372,036,854,775,807     [highest range, we never used] [we have to use l at the end]
		
		float = decimal till 6 to 7 digit [example: 3.1415927]   [we have to use f at the end]
		
		double = decimal till 15 to 16 digit [example: 3.1415927410125732]  [mostly used]
...
6) Is Java Strongly Typed Language? (will discuss later)
